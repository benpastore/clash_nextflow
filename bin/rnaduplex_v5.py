...
def run_rnaduplex(seq_pair):
    ...
    target_bulges, smrna_bulges = detect_bulges(structure_fixed)

    return seq_pair, binding_energy, structure_fixed, ts_seq, target_bulges, smrna_bulges
...
def main() : 
    ...
    df_results = pd.DataFrame(results, columns=["duplex_input", "binding_energy", "structure_fixed", "target_site_seq", "target_bulges", "smrna_bulges"])
